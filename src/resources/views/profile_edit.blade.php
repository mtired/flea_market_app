      ...
      <form class="profile-edit__form" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="profile-edit__image-row">
          ...
          <div class="profile-edit__image-action">
            <input id="image" class="profile-edit__file" type="file" name="image" accept="image/*">
        ...
        <div class="profile-edit__group">
          ...
          <input class="profile-edit__input profile-edit__input--bold" id="name" name="name" type="text"
            value="{{ old('name', $user->name ?? '') }}" placeholder="既存の値が入力されている">
          @error('name')
            <p class="profile-edit__error">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="profile-edit__group">
          ...
          <input class="profile-edit__input" id="postal_code" name="postal_code" type="text"
            value="{{ old('postal_code', $profile->postal_code ?? '') }}" placeholder="既存の値が入力されている">
          @error('postal_code')
            <p class="profile-edit__error">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="profile-edit__group">
          ...
          <input class="profile-edit__input" id="address" name="address" type="text"
            value="{{ old('address', $profile->address ?? '') }}" placeholder="既存の値が入力されている">
          @error('address')
            <p class="profile-edit__error">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="profile-edit__group">
          ...
          <input class="profile-edit__input" id="building" name="building" type="text"
            value="{{ old('building', $profile->building ?? '') }}" placeholder="既存の値が入力されている">
          @error('building')
            <p class="profile-edit__error">{{ $message }}</p>
          @enderror
        </div>
