      ...
      <form class="product-create__form" action="/sell" method="post" enctype="multipart/form-data">
        ...
        <div class="product-create__block">
          ...
          <div class="product-create__image-area">
            <input class="product-create__file-input" type="file" name="image" id="image" accept="image/*">
          ...
          <div class="product-create__block">
            ...
            <div class="product-create__categories">
              @foreach ($categories as $category)
                <input type="checkbox" name="category_ids[]" id="cat-{{ $category->id }}" value="{{ $category->id }}"
        ...
        <div class="product-create__section">
          ...
          <div class="product-create__block">
            ...
            <input class="product-create__input" type="text" name="name" value="{{ old('name') }}">
            @error('name')
              <p class="form-error">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div class="product-create__block">
            ...
            <input class="product-create__input" type="text" name="brand" value="{{ old('brand') }}">
            @error('brand')
              <p class="form-error">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div class="product-create__block">
            ...
            <textarea class="product-create__textarea" name="description">{{ old('description') }}</textarea>
            @error('description')
              <p class="form-error">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div class="product-create__block">
            ...
            <div class="product-create__price">
              ...
              <input class="product-create__price-input" type="text" name="price" value="{{ old('price') }}"
                inputmode="numeric">
            </div>
            @error('price')
              <p class="form-error">{{ $message }}</p>
